...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/Grenade.png
  AssetGenImage get grenade => const AssetGenImage('assets/images/Grenade.png');

  /// File path: assets/images/Run.png
  AssetGenImage get run => const AssetGenImage('assets/images/Run.png');

  /// File path: assets/images/background.gif
  AssetGenImage get background =>
      const AssetGenImage('assets/images/background.gif');

  /// File path: assets/images/bunny_sprite.png
...
class $AssetsTilesGen {
  ...
  /// File path: assets/tiles/my_tile.tmx
  String get myTile => 'assets/tiles/my_tile.tmx';

  /// List of all assets
  List<String> get values => [myTile];
}
